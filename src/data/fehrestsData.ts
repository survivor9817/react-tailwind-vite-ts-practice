...
export const getFehrestById = (bookId: string) => {
...
export const createFakeBookPagesContent = (bookId: string) => {
...
export const getBookPage = (bookId: string, pageNumber: number) => {
