...
import type { QuizFiltersType } from "./Quiz";
...
const QuizFilters = ({ setQuizStatus }: Props) => {
  // use quiz
  ...
  return (
    <form className="flex flex-col justify-center items-center w-full h-125 p-2" action={startQuiz}>
